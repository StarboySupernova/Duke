...
struct Row1Cell: View {
    var body: some View {
        HStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                .background(RoundedCorners(topLeft: 2.0, topRight: 2.0, bottomLeft: 2.0,
                                           bottomRight: 2.0)
                        .fill(ColorConstants.Black90033))
        ...
        .background(RoundedCorners(topLeft: 10.0, topRight: 10.0, bottomLeft: 10.0,
                                   bottomRight: 10.0)
                .fill(ColorConstants.WhiteA70019))
        .shadow(color: ColorConstants.WhiteA70033, radius: 0, x: 0, y: 0)
        .hideNavigationBar()
    }
}
...
struct Row1Cell_Previews: PreviewProvider {
